export default {
  ...
  keys: {
    ...
    modelQuotaSection: 'Per-Model Quotas',
    modelQuotaHint: 'Set independent USD limits for specific requested models. Leave empty to skip model-level limits.',
    modelQuotaAdd: 'Add Model Limit',
    modelQuotaEmpty: 'No model quota rules yet.',
    modelQuotaModelLabel: 'Model',
    modelQuotaModelPlaceholder: 'e.g. gpt-4.1-mini',
    modelQuotaLimitLabel: 'Limit (USD)',
    modelQuotaLimitPlaceholder: '0.00',
    modelQuotaUsedLabel: 'Used',
    modelQuotaConfiguredCount: '{count} model quota rules configured',
    modelQuotaValidationIncomplete: 'Each model quota row must include a model name and a limit.',
    modelQuotaValidationLimit: 'Model quota limits must be greater than 0.',
    modelQuotaValidationDuplicate: 'Duplicate model quota entry: {model}',
    resetModelQuotaUsage: 'Reset model quota usage',
    resetModelQuotaTitle: 'Confirm Reset Model Quotas',
    resetModelQuotaConfirmMessage: 'Are you sure you want to reset all model quota usage for key "{name}"? This action cannot be undone.',
    modelQuotaResetSuccess: 'Model quota usage reset successfully',
    failedToResetModelQuota: 'Failed to reset model quota usage',
  ...
  admin: {
    ...
    accounts: {
      ...
      cpaImportTitle: 'Import CPA Auth Files',
      cpaImportHint: 'Upload the CPA root folder, or upload auths/*.json together with config/config.yaml. The backend will convert them into native sub2api import data.',
      cpaImportWarning: 'This import creates new accounts. Legacy API keys from CPA config are preserved separately for manual follow-up. Disabled accounts and service-account entries are skipped intentionally.',
      cpaImportFiles: 'CPA files',
      cpaImportSupportedFiles: 'Supports auths/*.json and config/config.yaml',
      cpaImportChooseFolder: 'Choose Folder',
      cpaImportChooseFiles: 'Choose Files',
      cpaImportSelectFiles: 'Please select CPA files or folder',
      cpaImportSelectedFiles: '{count} files selected',
      cpaImportSkipDefaultGroupBind: 'Do not auto-bind the platform default group after import',
      cpaImportButton: 'Convert and Import',
      cpaImporting: 'Importing...',
      cpaImportFailed: 'CPA import failed',
      cpaImportSuccess: 'CPA import completed: accounts {account_created}, skipped {accounts_skipped}, preserved legacy keys {api_keys_preserved}',
      cpaImportCompletedWithErrors: 'CPA import completed with issues: account failed {account_failed}, proxy failed {proxy_failed}, skipped {accounts_skipped}',
      cpaImportResult: 'CPA Import Result',
      cpaImportSeen: 'Accounts Seen',
      cpaImportConverted: 'Imported',
      cpaImportSkipped: 'Skipped',
      cpaImportKeysPreserved: 'Keys Preserved',
      cpaImportWarnings: 'Conversion Warnings',
      cpaImportSkippedDetails: 'Skipped Details',
      cpaImportPreservedKeys: 'Preserved Legacy API Keys',
      cpaImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}; Accounts created {account_created}; Skipped {accounts_skipped}; Preserved legacy keys {api_keys_preserved}',
