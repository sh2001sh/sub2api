...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/sh2001sh/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/sh2001sh/sub2api
